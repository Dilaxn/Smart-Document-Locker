 ...
 * Support : R30X Optical Fingerprint Series with Atmega 328p
...
uint16_t finger_generate_template();			// combine buffers to generate template
...
uint16_t finger_delete(uint16_t);				// deletes the template at the location. send location to delete
uint16_t finger_search();						// search flash storage for matching templates
